...
interface MessageProps {
    ...
    DeleteHandler: (mID: string) => void | undefined;

}

const Message: React.FC<MessageProps> = ({ msg, id, ReplyHandler ,DeleteHandler }) => {
        ...
        <div className={`chat ${msg.kinderId === id ? 'chat-end' : 'chat-start'}`}>
            {
                msg.kinderId !== id ?
                    ...
                    :
                    <div className="flex gap-1 group relative"> {/* Added 'relative' for positioning */}
                        <div onClick={
                            () => {
