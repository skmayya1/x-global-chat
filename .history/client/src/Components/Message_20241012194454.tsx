...
const Message: React.FC<MessageProps> = ({ msg, id }) => {
    ...
    const colors = ["text-red-500", "text-blue-500", "text-green-500", "text-purple-500", "text-pink-500", "text-teal-500"];
                ...
                msg.kinderId !== id ?
                    ...
                    <div className="flex items-center justify-center gap-2">
                        ...
                        <div className="bg-zinc-800 rounded-lg px-2 py-1">
                            <div className={`font-medium text-xs ${senderColor}`}>{msg.sender_name}</div>
