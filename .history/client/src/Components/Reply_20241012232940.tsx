      ...
      <div className='flex w-full justify-between items-center px-4 py-1.5 bg-[#121212]'>
          <div className="flex gap-1 items-center ">
              ...
              <div className="px-2">
                  ...
                  <p className='text-sm font-light w-56 overflow-hidden  inset-0 bg-gradient-to-r from-transparent via-transparent to-[] opacity-50 pointer-events-none'>{ReplyData.ReplyToText}</p>
              </div>
          </div>
          <button onClick={() => {
              setReplyData({
