    ...
    <div className="h-screen w-full flex flex-col relative">
      ...
      <div className="overflow-y-scroll h-full w-full flex flex-col px-1.5">
        <div className="flex items-center justify-center w-full my-5 gap-2 text-sm">
          Developed By <button className="bg-zinc-950 underline flex  items-center gap-1 font-semibold "><a href="https://x.com/Skmayya1">@Skmayya</a><FaXTwitter size={15} /></button>
        </div>
