...
export async function consumeMessages() {
    ...
    const consumer = kafka.consumer({ groupId: 'messages-group' }); // Changed groupId
...
export async function consumeDeleteMessages() {
    ...
    const consumer = kafka.consumer({ groupId: 'delete-group' }); // Changed groupId
    await consumer.connect();
    ...
    await consumer.run({
        ...
        eachMessage: async ({ message, pause }) => {
            ...
            console.log('Message received:', mID);
