        ...
        <div className={`chat ${msg.kinderId === id ? 'chat-end' : 'chat-start'}`}>
            {
                msg.kinderId !== id ?
                    ...
                    <div className="flex items-center justify-center gap-2">
                        ...
                        <div className="bg-zinc-800 rounded-lg px-2 py-1 max-w-xs">
                            <div className={`font-medium text-sm ${senderColor}`}>{msg.sender_name}</div>
                            <div className="flex gap-3">
                                <div className="self-center font-medium break-words whitespace-normal">{msg.text}</div>
                    ...
                    <div className="flex gap-3 bg-zinc-800 rounded-lg px-2 py-1 max-w-xs break-words whitespace-normal">
