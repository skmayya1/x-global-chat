...
const Message: React.FC<MessageProps> = ({ msg, id }) => {
    ...
    function formatTime(createdAt: string): string {
        console.log("Raw createdAt value:", createdAt); // Log the raw value
        const date = new Date(createdAt.trim()); // Trim to remove any whitespace
                    ...
                    <div className="flex items-center justify-center gap-2">
                        ...
                        <div className="bg-zinc-800 rounded-lg px-2 py-1">
                            ...
                            <div className="flex gap-3">
                                ...
                                <div className="self-end text-xs font-extralight">{formatTime(msg.)}</div>
                            </div>
                        </div>
                    </div>
                    :
