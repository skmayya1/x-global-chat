                ...
                msg.kinderId !== id ?
                    ...
                    <div className="flex items-center justify-center gap-2">
                        ...
                        <div className="bg-zinc-800 rounded-lg max-w-[32vh] px-2 py-1 overflow-hidden">
                            ...
                            {msg.ReplyToId && 
                                <div className="bg-zinc-700 h-14 min-w-[28vw] mb-1 border-l-2 rounded-lg flex flex-col items-start p-2 overflow-hidden">
                                    <div className="text-sm text-white font-base">{msg.ReplyToNAme?.split(' ')[0]}</div>
                                    <div className="text-sm">{msg.ReplyToText}</div>
                               </div>
                            }
                    ...
                    <div className="bg-zinc-800 rounded-lg max-w-[32vh] px-2 py-1 overflow-hidden">
                        {msg.ReplyToId &&
                            <div className="bg-zinc-700 h-14 w-[28vw] mb-1 border-l-2 rounded-lg flex flex-col items-start p-2 overflow-hidden">
                                <div className="text-sm text-white font-base">{msg.ReplyToNAme?.split(' ')[0]}</div>
                                <div className="text-sm  whitespace-pre-wrap break-words">{msg.ReplyToText}</div>
                            </div>
                        }
                        <div className="flex gap-3 w-full justify-between">
                            <div className="self-center max-w-[20vh] 
