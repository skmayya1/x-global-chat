...
const Message: React.FC<MessageProps> = React.memo(({ msg, id, ReplyHandler, DeleteHandler }) => {
        ...
        <div className={`chat ${msg.kinderId === id ? 'chat-end' : 'chat-start'}`}>
            {msg.kinderId !== id ? (
                <div className="flex items-center justify-center gap-2">
                    ...
                    <div className="bg-zinc-800 rounded-lg max-w-[32vh] px-2 py-1 overflow-hidden hover:bg-zinc-700 transition-colors duration-150 mb-1">
                    ...
                    <button
                        onClick={() => ReplyHandler(msg.sender_name, msg.mID, msg.text)}
                ...
                <div className="flex gap-1 group relative">
                    <div
                        onClick={() => DeleteHandler(msg.mID)}
                        className="absolute -left-8 p-1 scale-0 group-hover:scale-125 transition-transform duration-150 h-fit w-fit rounded-full"
                    >
