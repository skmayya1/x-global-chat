...
const GlobalChat = () => {
  ...
  return (
    <div className="h-full sm:w-[70%] justify-center w-full flex flex-col relative">
      ...
      <form onSubmit={SubmitHandler} className="flex w-full py-1 items-center justify-center border-t border-zinc-800 gap-2 fixed bottom-0 bg-[#121212]">
        <input
          ref={input}
