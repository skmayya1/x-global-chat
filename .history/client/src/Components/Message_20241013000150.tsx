                ...
                msg.kinderId !== id ?
                    ...
                    <div className="flex items-center justify-center gap-2">
                        ...
                        <div className="bg-zinc-800 rounded-lg max-w-[32vh] px-2 py-1 overflow-hidden">
                            ...
                            {msg.ReplyToId && 
                                <div className="bg-zinc-700 h-8 w-[20vw] rounded-lg flex flex-col items-center justify-around">
                                    <div className="text-sm text-white font-semibold">{msg.ReplyToNAme?.split(' ')[0]}</div>
                    ...
                    <div className="flex gap-3 bg-zinc-800 rounded-lg px-2 py-1 max-w-[32vh]">
                        <div className="self-center max-w-[20vh] 
                                 whitespace-pre-wrap break-words
                                font-medium ">{msg.text}</div>
                        <div className="self-end text-xs font-extralight">{formatTime(msg.createdAt)}</div>
