  ...
  return (
    <div className="h-screen w-full flex flex-col relative">
      ...
      <div className="overflow-y-scroll h-full w-full flex flex-col px-1.5">
        <div className="flex items-center justify-center max-w-[20vw]">
          Developed By <button className="bg-zinc-950"><FaXTwitter size={15} /></button>
        </div>
        {Object.entries(groupedMessages).map(([date, messages]) => (
          <div key={date} className="mb-2">
            <div className="flex justify-center mb-2">
              <div className="bg-zinc-700 text-gray-300 text-sm rounded-full px-3 py-1">
                {date}
              </div>
            </div>
