...
const GlobalChat = () => {
  ...
  return (
    <div className="h-screen w-full flex flex-col relative">
      <button className="flex items-center justify-around gap-10 border-b border-zinc-800">
        <div>
          <CiLogout />
        </div>
      ...
      {isLoading && data ? <div className="flex items-center justify-center h-full w-full absolute">Loading...</div> :
        <div className="overflow-y-scroll self-auto h-full w-full  px-1.5 flex flex-col-reverse  mb-14" >
          {Object.entries(groupedMessages).map(([date, messages]) => (
            <div key={date} className="mb-2 flex flex-col ">
