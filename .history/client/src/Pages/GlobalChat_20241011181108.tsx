...
const GlobalChat = () => {
  ...
  return (
    <div className="h-screen w-full flex flex-col relative">
      <div className="h-16 border-b border-zinc-800 w-full text-white flex items-center justify-center relative">
        <h1 className="font-mono text-xl">GLOBAL CHAT</h1>
        <span className="absolute right-5 text-xs font-mono font-extralight border border-green-400 text-green-400 bg-green-400 bg-opacity-50 rounded-full px-2 py-0.5">
          members: 5
        </span>
      </div>
      <div>
