...
const GlobalChat = () => {
  ...
  return (
    <div className="h-full sm:w-[70%] w-full flex sm:mx-auto flex-col relative">
      <div className="flex items-center justify-around sm:justify-between sm:px-5 gap-10 border-b border-zinc-800">
      ...
      {isLoading && data ? <div className="flex items-center justify-center h-full w-full absolute">Loading...</div> :
        <div id="messageContainer" className="overflow-y-scroll self-auto h-full w-full  px-1.5 flex  mb-14 flex-col-reverse overflow-auto scrollbar-thin scrollbar-thumb-transparent" >
          {Object.entries(groupedMessages).map(([date, messages]) => (
            <div key={date} className="mb-2 flex flex-col-reverse ">
      ...
      <form onSubmit={SubmitHandler} className="flex w-full py-1 sm:w-[70%] items-center justify-center border-t border-zinc-800 gap-2 fixed bottom-0 bg-[#121212]">
        <input
          ref={input}
